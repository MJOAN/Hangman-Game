var chooseWord = ["acoustics", "adiabatic", "albedo", "acceleration", "ampere",
    ...
    // VARIABLES
      // ==========================================================================
        ...
        var userGuses, hangmanWord, userGuess;
        var userWin, userLoss, lettersAlreadyGuessed = 0;
    ...
    // FUNCTIONS
      // ==============================================================================
        ...
        function startGame() {
            ...
            var placeHolderForWord = [];
            var lettersAlreadyGuessed = placeHolderForWord.length[i];
    ...
    // MAIN PROCESS
      ...
      document.onkeyup = function(event) {
            ...
            var userGuess = document.addEventListener("onkeyup", startGame());
